...
import FilterCard from "~/components/AppBar/Menus/FilterCard";
// --------------------- STYLES -------------------------
const MENU_STYLES = {
    display: "flex",
    alignItems: "center",
...
const MENU_ITEMS_FILTER = {
    width: "150px",
    borderBottom: (theme) => `1px solid ${theme.trello.colorMidnightBlue}`,
};
